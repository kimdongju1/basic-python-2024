...
class WinApp(QWidget):
    ...
    def initUI(self):
        # 이미지 추가 .scaledToWidth(800) 큰 해상도를 넓이 800으로 고정 
        pixmap = QPixmap('./images/kitty.jpg').scaledToWidth(800)
        lblImage = QLabel(self)
        lblImage.setPixmap(pixmap)
        
        lblSize = QLabel(self)
        lblSize.setFont(QFont('NanumGothicCoding', 20)) # 폰트와 사이즈 
        lblSize.setStyleSheet('Color: #66CC00;')
...
if __name__ == '__main__':
    ...
    screen_rect = app.desktop().screenGeometry() # 모니터 해상도 구하는 법 1
